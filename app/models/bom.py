...
class BomItem(Base):
    ...
    parent_assembly_id = Column("parent_assembly_id", Integer, ForeignKey("parts.part_id"))
    parent_assembly = Column("parent_assembly", String)
    ...
    part = relationship("Part", back_populates="bom_items", foreign_keys=[part_id])
    parent = relationship("Part", foreign_keys=[parent_assembly_id])
