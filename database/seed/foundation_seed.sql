...
-- ══ Stage 1b: 10-level BOM sample chain ══════════════════════════════════════
-- Used by the BOM page to exercise depth, +, -, and save round-trips.
-- Chain: ASM-1001 -> PRT-1002 -> PRT-1003 -> ... -> PRT-1011
...
('00000000-0000-4000-8000-000000000020',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'Part',
 '00000000-0000-4000-8000-000000000999',
 'ASM', '1001', 'Test Assembly 10-Level',
 'Root of the 10-level BOM sample chain', 'A',
 'released', '2026-01-01', false,
 'seed', '2025-06-01 09:00:00+00', 'seed', '2025-12-15 16:20:00+00',
 '{}'::jsonb, '{}'::jsonb),
...
('00000000-0000-4000-8000-000000000021',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'Part',
 '00000000-0000-4000-8000-000000000999',
 'PRT', '1002', 'Level-01 Component',
 'Component at BOM level 1', 'A',
 'released', '2026-01-01', false,
 'seed', '2025-06-01 09:05:00+00', 'seed', '2025-12-15 16:20:00+00',
 '{}'::jsonb, '{}'::jsonb),

('00000000-0000-4000-8000-000000000022',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'Part',
 '00000000-0000-4000-8000-000000000999',
 'PRT', '1003', 'Level-02 Component',
 'Component at BOM level 2', 'A',
 'released', '2026-01-01', false,
 'seed', '2025-06-01 09:10:00+00', 'seed', '2025-12-15 16:20:00+00',
 '{}'::jsonb, '{}'::jsonb),

('00000000-0000-4000-8000-000000000023',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'Part',
 '00000000-0000-4000-8000-000000000999',
 'PRT', '1004', 'Level-03 Component',
 'Component at BOM level 3', 'A',
 'released', '2026-01-01', false,
 'seed', '2025-06-01 09:15:00+00', 'seed', '2025-12-15 16:20:00+00',
 '{}'::jsonb, '{}'::jsonb),

('00000000-0000-4000-8000-000000000024',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'Part',
 '00000000-0000-4000-8000-000000000999',
 'PRT', '1005', 'Level-04 Component',
 'Component at BOM level 4', 'A',
 'released', '2026-01-01', false,
 'seed', '2025-06-01 09:20:00+00', 'seed', '2025-12-15 16:20:00+00',
 '{}'::jsonb, '{}'::jsonb),

('00000000-0000-4000-8000-000000000025',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'Part',
 '00000000-0000-4000-8000-000000000999',
 'PRT', '1006', 'Level-05 Component',
 'Component at BOM level 5', 'A',
 'released', '2026-01-01', false,
 'seed', '2025-06-01 09:25:00+00', 'seed', '2025-12-15 16:20:00+00',
 '{}'::jsonb, '{}'::jsonb),

('00000000-0000-4000-8000-000000000026',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'Part',
 '00000000-0000-4000-8000-000000000999',
 'PRT', '1007', 'Level-06 Component',
 'Component at BOM level 6', 'A',
 'released', '2026-01-01', false,
 'seed', '2025-06-01 09:30:00+00', 'seed', '2025-12-15 16:20:00+00',
 '{}'::jsonb, '{}'::jsonb),

('00000000-0000-4000-8000-000000000027',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'Part',
 '00000000-0000-4000-8000-000000000999',
 'PRT', '1008', 'Level-07 Component',
 'Component at BOM level 7', 'A',
 'released', '2026-01-01', false,
 'seed', '2025-06-01 09:35:00+00', 'seed', '2025-12-15 16:20:00+00',
 '{}'::jsonb, '{}'::jsonb),

('00000000-0000-4000-8000-000000000028',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'Part',
 '00000000-0000-4000-8000-000000000999',
 'PRT', '1009', 'Level-08 Component',
 'Component at BOM level 8', 'A',
 'released', '2026-01-01', false,
 'seed', '2025-06-01 09:40:00+00', 'seed', '2025-12-15 16:20:00+00',
 '{}'::jsonb, '{}'::jsonb),

('00000000-0000-4000-8000-000000000029',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'Part',
 '00000000-0000-4000-8000-000000000999',
 'PRT', '1010', 'Level-09 Component',
 'Component at BOM level 9', 'A',
 'released', '2026-01-01', false,
 'seed', '2025-06-01 09:45:00+00', 'seed', '2025-12-15 16:20:00+00',
 '{}'::jsonb, '{}'::jsonb),

('00000000-0000-4000-8000-000000000030',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'Part',
 '00000000-0000-4000-8000-000000000999',
 'PRT', '1011', 'Level-10 Component',
 'Leaf component at BOM level 10', 'A',
 'released', '2026-01-01', false,
 'seed', '2025-06-01 09:50:00+00', 'seed', '2025-12-15 16:20:00+00',
 '{}'::jsonb, '{}'::jsonb);
...
('00000000-0000-4000-9000-000000000020',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'BOM', 'Has component',
 '00000000-0000-4000-8000-000000000020', 'Part',
 '00000000-0000-4000-8000-000000000021', 'Part',
 'active', '2026-01-01', NULL,
 '00000000-0000-4000-8000-000000000102', 'E',
 'seed', '2025-06-01 09:05:00+00', 'seed', '2025-06-01 09:05:00+00',
 '{}'::jsonb, '{"quantity": 1, "unitOfMeasure": "EA", "findNumber": "010"}'),

('00000000-0000-4000-9000-000000000021',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'BOM', 'Has component',
 '00000000-0000-4000-8000-000000000021', 'Part',
 '00000000-0000-4000-8000-000000000022', 'Part',
 'active', '2026-01-01', NULL,
 '00000000-0000-4000-8000-000000000102', 'E',
 'seed', '2025-06-01 09:10:00+00', 'seed', '2025-06-01 09:10:00+00',
 '{}'::jsonb, '{"quantity": 2, "unitOfMeasure": "EA", "findNumber": "020"}'),

('00000000-0000-4000-9000-000000000022',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'BOM', 'Has component',
 '00000000-0000-4000-8000-000000000022', 'Part',
 '00000000-0000-4000-8000-000000000023', 'Part',
 'active', '2026-01-01', NULL,
 '00000000-0000-4000-8000-000000000102', 'E',
 'seed', '2025-06-01 09:15:00+00', 'seed', '2025-06-01 09:15:00+00',
 '{}'::jsonb, '{"quantity": 2, "unitOfMeasure": "EA", "findNumber": "030"}'),

('00000000-0000-4000-9000-000000000023',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'BOM', 'Has component',
 '00000000-0000-4000-8000-000000000023', 'Part',
 '00000000-0000-4000-8000-000000000024', 'Part',
 'active', '2026-01-01', NULL,
 '00000000-0000-4000-8000-000000000102', 'E',
 'seed', '2025-06-01 09:20:00+00', 'seed', '2025-06-01 09:20:00+00',
 '{}'::jsonb, '{"quantity": 4, "unitOfMeasure": "EA", "findNumber": "040"}'),

('00000000-0000-4000-9000-000000000024',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'BOM', 'Has component',
 '00000000-0000-4000-8000-000000000024', 'Part',
 '00000000-0000-4000-8000-000000000025', 'Part',
 'active', '2026-01-01', NULL,
 '00000000-0000-4000-8000-000000000102', 'E',
 'seed', '2025-06-01 09:25:00+00', 'seed', '2025-06-01 09:25:00+00',
 '{}'::jsonb, '{"quantity": 1, "unitOfMeasure": "EA", "findNumber": "050"}'),

('00000000-0000-4000-9000-000000000025',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'BOM', 'Has component',
 '00000000-0000-4000-8000-000000000025', 'Part',
 '00000000-0000-4000-8000-000000000026', 'Part',
 'active', '2026-01-01', NULL,
 '00000000-0000-4000-8000-000000000102', 'E',
 'seed', '2025-06-01 09:30:00+00', 'seed', '2025-06-01 09:30:00+00',
 '{}'::jsonb, '{"quantity": 3, "unitOfMeasure": "EA", "findNumber": "060"}'),

('00000000-0000-4000-9000-000000000026',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'BOM', 'Has component',
 '00000000-0000-4000-8000-000000000026', 'Part',
 '00000000-0000-4000-8000-000000000027', 'Part',
 'active', '2026-01-01', NULL,
 '00000000-0000-4000-8000-000000000102', 'E',
 'seed', '2025-06-01 09:35:00+00', 'seed', '2025-06-01 09:35:00+00',
 '{}'::jsonb, '{"quantity": 2, "unitOfMeasure": "EA", "findNumber": "070"}'),

('00000000-0000-4000-9000-000000000027',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'BOM', 'Has component',
 '00000000-0000-4000-8000-000000000027', 'Part',
 '00000000-0000-4000-8000-000000000028', 'Part',
 'active', '2026-01-01', NULL,
 '00000000-0000-4000-8000-000000000102', 'E',
 'seed', '2025-06-01 09:40:00+00', 'seed', '2025-06-01 09:40:00+00',
 '{}'::jsonb, '{"quantity": 5, "unitOfMeasure": "EA", "findNumber": "080"}'),

('00000000-0000-4000-9000-000000000028',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'BOM', 'Has component',
 '00000000-0000-4000-8000-000000000028', 'Part',
 '00000000-0000-4000-8000-000000000029', 'Part',
 'active', '2026-01-01', NULL,
 '00000000-0000-4000-8000-000000000102', 'E',
 'seed', '2025-06-01 09:45:00+00', 'seed', '2025-06-01 09:45:00+00',
 '{}'::jsonb, '{"quantity": 1, "unitOfMeasure": "EA", "findNumber": "090"}'),

('00000000-0000-4000-9000-000000000029',
 '11111111-1111-1111-1111-111111111111', 'foundation', 'BOM', 'Has component',
 '00000000-0000-4000-8000-000000000029', 'Part',
 '00000000-0000-4000-8000-000000000030', 'Part',
 'active', '2026-01-01', NULL,
 '00000000-0000-4000-8000-000000000102', 'E',
 'seed', '2025-06-01 09:50:00+00', 'seed', '2025-06-01 09:50:00+00',
 '{}'::jsonb, '{"quantity": 2, "unitOfMeasure": "EA", "findNumber": "100"}');
