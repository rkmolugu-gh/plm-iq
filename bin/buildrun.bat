...
if /i "%ACTION%"=="build" (
    ...
    docker compose --project-directory "%PLMIQ_ROOT%" --env-file "%PLMIQ_ROOT%\.env" -f "%PLMIQ_ROOT%\bin\docker-compose.%PROFILE%.yml" build
...
if /i "%ACTION%"=="run" (
    ...
    docker compose --project-directory "%PLMIQ_ROOT%" --env-file "%PLMIQ_ROOT%\.env" -f "%PLMIQ_ROOT%\bin\docker-compose.%PROFILE%.yml" up -d
