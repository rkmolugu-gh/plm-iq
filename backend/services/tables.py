...
foundation_graph_rule = Table(
    ...
    Column("source_lifecycle_states", ARRAY(_enum(enums.LifecycleState, "lifecycle_state")), nullable=False),
    Column("target_lifecycle_states", ARRAY(_enum(enums.LifecycleState, "lifecycle_state")), nullable=False),
    Column("required_edge_attributes", ARRAY(Text()), nullable=False),
