...
-- workflow_templates (sample workflow definitions in v2 format)
INSERT OR IGNORE INTO workflow_templates (id, name, object_type, description, definition, is_active, is_global, created_by, tenant_key, created_at) VALUES
    (1, 'Standard Part Release', 'part', 'Standard workflow for releasing a new part', '{"version": 2, "stages": [{"name": "Engineering", "parallel": false, "steps": [{"key": "eng", "name": "Engineering Review", "assignee_type": "role", "assignee": "author", "description": "Review CAD data and BOM for manufacturability", "due_days": 3}]}, {"name": "Approvals", "parallel": true, "threshold": 2, "steps": [{"key": "qa", "name": "QA Approval", "assignee_type": "role", "assignee": "quality", "description": "Verify quality standards compliance", "due_days": 5}, {"key": "mfg", "name": "Mfg Approval", "assignee_type": "role", "assignee": "manufacturing", "description": "Verify manufacturability and cost", "due_days": 5}]}, {"name": "Release", "parallel": false, "steps": [{"key": "rel", "name": "Release", "assignee_type": "role", "assignee": "tenantadmin", "description": "Final release authorization", "due_days": 2}]}]}', TRUE, TRUE, 1, 'tk_plm_iq_superadmin', '2024-01-01'),
    (2, 'ECO Approval', 'eco', 'Workflow for approving engineering change orders', '{"version": 2, "stages": [{"name": "Review", "parallel": false, "steps": [{"key": "rev", "name": "Change Review", "assignee_type": "role", "assignee": "author", "description": "Review the change description and impact", "due_days": 3}]}, {"name": "Approvals", "parallel": true, "threshold": 2, "steps": [{"key": "qa", "name": "QA Approval", "assignee_type": "role", "assignee": "quality", "description": "Verify quality standards compliance", "due_days": 5}, {"key": "mfg", "name": "Mfg Approval", "assignee_type": "role", "assignee": "manufacturing", "description": "Verify manufacturability and cost", "due_days": 5}]}, {"name": "Release", "parallel": false, "steps": [{"key": "rel", "name": "Release Change", "assignee_type": "role", "assignee": "tenantadmin", "description": "Final release authorization", "due_days": 2}]}]}', TRUE, TRUE, 1, 'tk_plm_iq_superadmin', '2024-01-01');
