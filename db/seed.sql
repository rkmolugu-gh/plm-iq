...
INSERT OR IGNORE INTO workflow_definitions (id, name, object_type, description, definition, is_active, is_global, created_by, tenant_key, created_at) VALUES
    (1, 'Standard Part Release', 'part', 'Standard workflow for releasing a new part', '{"version": 2, "stages": [{"name": "Engineering", "parallel": false, "steps": [{"key": "eng", "name": "Engineering Review", "assignee_type": "role", "assignee": "design_engineer", "description": "Review CAD data, specifications, and BOM for manufacturability and compliance", "due_days": 3}]}, {"name": "Approvals", "parallel": true, "threshold": 2, "steps": [{"key": "qa", "name": "Quality Approval", "assignee_type": "role", "assignee": "quality", "description": "Verify quality standards, tolerances, and inspection requirements", "due_days": 5}, {"key": "mfg", "name": "Manufacturing Approval", "assignee_type": "role", "assignee": "manufacturing", "description": "Verify manufacturability, process capability, and production cost", "due_days": 5}]}, {"name": "Release", "parallel": false, "steps": [{"key": "rel", "name": "Release Authorization", "assignee_type": "role", "assignee": "release_engineer", "description": "Final release authorization - verify all approvals complete and part is ready for production", "due_days": 2}]}]}', TRUE, TRUE, 1, 'tk_plm_iq_superadmin', '2024-01-01'),
    (2, 'ECO Approval', 'eco', 'Workflow for approving engineering change orders', '{"version": 2, "stages": [{"name": "Review", "parallel": false, "steps": [{"key": "rev", "name": "Change Review", "assignee_type": "role", "assignee": "design_engineer", "description": "Review the change description, impact analysis, and technical feasibility", "due_days": 3}]}, {"name": "Approvals", "parallel": true, "threshold": 2, "steps": [{"key": "qa", "name": "Quality Approval", "assignee_type": "role", "assignee": "quality", "description": "Verify quality impact, test requirements, and compliance changes", "due_days": 5}, {"key": "mfg", "name": "Manufacturing Approval", "assignee_type": "role", "assignee": "manufacturing", "description": "Verify manufacturing impact, process changes, and cost implications", "due_days": 5}]}, {"name": "Release", "parallel": false, "steps": [{"key": "rel", "name": "Change Release", "assignee_type": "role", "assignee": "release_engineer", "description": "Final change release authorization - verify all approvals and implementation plan", "due_days": 2}]}]}', TRUE, TRUE, 1, 'tk_plm_iq_superadmin', '2024-01-01');
