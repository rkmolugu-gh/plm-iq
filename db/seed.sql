...
INSERT INTO bom (id, level, part_number, part_revision, part_name, qty, uom, parent_assembly, material_notes, bom_type, tenant_id, tenant_key) VALUES
    ...
    (11, 0, 'VEL-001', 'B', 'Derailleur Hanger', 1, 'EA', NULL, 'Replaceable hanger design', 'PRODUCTION', 3, 'tk_veloparts_i9j0k1l2'),
    (12, 1, 'VEL-002', 'A', 'Bottom Bracket - BSA', 1, 'EA', 'VEL-001', 'English thread standard', 'PRODUCTION', 3, 'tk_veloparts_i9j0k1l2'),
    (13, 1, 'VEL-003', 'C', 'Headset - Integrated', 1, 'SET', 'VEL-001', 'IS42/28.6 top, IS52/40 bottom', 'PRODUCTION', 3, 'tk_veloparts_i9j0k1l2'),
    (14, 2, 'VEL-004', 'A', 'Quick Release Skewer', 2, 'SET', 'VEL-001', 'Front and rear skewers', 'PRODUCTION', 3, 'tk_veloparts_i9j0k1l2'),
    (15, 2, 'VEL-005', 'B', 'Cassette 11-Speed', 1, 'EA', 'VEL-001', '11-28T range', 'PRODUCTION', 3, 'tk_veloparts_i9j0k1l2'),
    ...
    (26, 0, 'PLM-001', 'A', 'API Gateway Module', 1, 'EA', NULL, 'Central API routing', 'SOFTWARE', 6, 'tk_plm_iq_superadmin'),
    (27, 1, 'PLM-002', 'B', 'Auth Service Component', 1, 'EA', 'PLM-001', 'JWT token management', 'SOFTWARE', 6, 'tk_plm_iq_superadmin'),
    (28, 1, 'PLM-003', 'A', 'Database Schema v2', 1, 'EA', 'PLM-001', 'PostgreSQL schema', 'SOFTWARE', 6, 'tk_plm_iq_superadmin'),
    (29, 2, 'PLM-004', 'C', 'UI Dashboard Widget', 1, 'EA', 'PLM-001', 'React dashboard components', 'SOFTWARE', 6, 'tk_plm_iq_superadmin'),
    (30, 2, 'PLM-005', 'A', 'MCP Server Plugin', 1, 'EA', 'PLM-001', 'Model Context Protocol support', 'SOFTWARE', 6, 'tk_plm_iq_superadmin');
...
INSERT INTO approved_manufacturer_list (part_number, part_revision, part_name, manufacturer_name, manufacturer_part_number, manufacturer_status, source_type, preferred_flag, lead_time_days, unit_cost, currency, compliance_status, quality_rating, approval_date, notes, tenant_id, tenant_key) VALUES
    ...
    ('PLM-001', 'A', 'API Gateway Module', 'PLM-IQ Development Team', 'PLM-API-A', 'PREFERRED', 'SOFTWARE', 'Yes', 0, 0.00, 'USD', 'SOC 2 Compliant', 'A', '2026-08-01', 'Internal development.', 6, 'tk_plm_iq_superadmin'),
    ('PLM-002', 'B', 'Auth Service Component', 'Auth0 by Okta', 'AUTH0-SVC-B', 'APPROVED', 'SOFTWARE', 'Yes', 0, 500.00, 'USD', 'SOC 2 Compliant', 'A', '2026-08-02', 'OAuth2 provider.', 6, 'tk_plm_iq_superadmin'),
    ('PLM-003', 'A', 'Database Schema v2', 'PostgreSQL Global Development', 'PG-SCHEMA-A', 'APPROVED', 'SOFTWARE', 'No', 0, 0.00, 'USD', 'Open Source', 'A', '2026-08-03', 'Database platform.', 6, 'tk_plm_iq_superadmin'),
    ('PLM-004', 'C', 'UI Dashboard Widget', 'React (Meta Open Source)', 'REACT-UI-C', 'APPROVED', 'SOFTWARE', 'Yes', 0, 0.00, 'USD', 'MIT License', 'A', '2026-08-04', 'UI framework.', 6, 'tk_plm_iq_superadmin'),
    ('PLM-005', 'A', 'MCP Server Plugin', 'Anthropic MCP Team', 'MCP-PLUGIN-A', 'APPROVED', 'SOFTWARE', 'Yes', 0, 0.00, 'USD', 'Open Source', 'A', '2026-08-05', 'MCP protocol support.', 6, 'tk_plm_iq_superadmin');
...
INSERT INTO approved_vendor_list (part_number, part_revision, part_name, vendor_name, vendor_site, vendor_contact, vendor_part_number, vendor_status, preferred_flag, lead_time_days, unit_price, currency, min_order_qty, moq_uom, payment_terms, shipping_method, contract_number, iso_certified, compliance_status, approval_date, notes, tenant_id, tenant_key) VALUES
    ...
    ('PLM-003', 'A', 'Database Schema v2', 'PostgreSQL Global', 'Open Source', 'info@postgresql.org', 'PG-SCHEMA-A', 'APPROVED', 'No', 0, 0.00, 'USD', 1, 'LICENSE', 'N/A', 'Digital Download', 'PG-2026-003', 'N/A', 'Open Source', '2026-08-03', 'Database platform.', 6, 'tk_plm_iq_superadmin'),
    ('PLM-004', 'C', 'UI Dashboard Widget', 'Meta Open Source', 'Open Source', 'opensource@meta.com', 'REACT-UI-C', 'APPROVED', 'Yes', 0, 0.00, 'USD', 1, 'LICENSE', 'N/A', 'Digital Download', 'META-2026-004', 'N/A', 'MIT License', '2026-08-04', 'UI framework.', 6, 'tk_plm_iq_superadmin'),
...
INSERT INTO cad_metadata (id, part_number, part_revision, part_name, status, cad_file_name, cad_file_format, cad_system, cad_version, file_reference_type, file_reference_url, file_size_bytes, file_checksum, modeling_author, cad_created_date, cad_modified_date, drawing_number, model_type, source_type, notes, tenant_id, tenant_key) VALUES
    ...
    (9, 'CYC-003', 'A', 'Chainring Set 52/36T', 'DRAFT', 'CYC-003_A.sldasm', 'SLDASM', 'Fusion 360', 'v2.0.15044', 'Google Drive', 'https://drive.google.com/cad/cycleworks/CYC-003_A.f3d', 4567890, 'F4B1HE67E0619I23', 11, '2021-01-10', '2021-05-12', 'DRW-CYC-003-A', 'ASSEMBLY', 'PURCHASED', 'Chainring assembly model.', 2, 'tk_cycleworks_e5f6g7h8'),
    ...
    (11, 'VEL-001', 'B', 'Derailleur Hanger', 'RELEASED', 'VEL-001_B.ipt', 'IPT', 'Autodesk Inventor 2024', '2024.1', 'OneDrive', 'https://onedrive.live.com/veloparts/cad/VEL-001_B.ipt', 2345678, 'H6D3JG89G2831K45', 15, '2021-04-15', '2022-02-10', 'DRW-VEL-001-B', 'PART', 'FABRICATED', 'CNC-machined hanger.', 3, 'tk_veloparts_i9j0k1l2'),
    (12, 'VEL-001', 'B', 'Derailleur Hanger', 'RELEASED', 'VEL-001_B.stp', 'STEP', 'Autodesk Inventor 2024', '2024.1', 'OneDrive', 'https://onedrive.live.com/veloparts/cad/VEL-001_B.stp', 2345678, 'H6D3JG89G2831K45', 15, '2021-04-15', '2022-02-10', 'DRW-VEL-001-B', 'PART', 'FABRICATED', 'STEP for CNC programming.', 3, 'tk_veloparts_i9j0k1l2'),
    (13, 'VEL-002', 'A', 'Bottom Bracket - BSA', 'RELEASED', 'VEL-002_A.ipt', 'IPT', 'Autodesk Inventor 2024', '2024.1', 'OneDrive', 'https://onedrive.live.com/veloparts/cad/VEL-002_A.ipt', 1234567, 'I7E4KH90H3942L56', 15, '2021-05-20', '2022-03-15', 'DRW-VEL-002-A', 'PART', 'PURCHASED', 'BSA bottom bracket model.', 3, 'tk_veloparts_i9j0k1l2'),
    (14, 'VEL-003', 'C', 'Headset - Integrated', 'DRAFT', 'VEL-003_C.iam', 'IAM', 'Autodesk Inventor 2024', '2024.1', 'OneDrive', 'https://onedrive.live.com/veloparts/cad/VEL-003_C.iam', 3456789, 'J8F5LI01I4053M67', 15, '2021-07-01', '2022-05-20', 'DRW-VEL-003-C', 'ASSEMBLY', 'PURCHASED', 'Headset assembly model.', 3, 'tk_veloparts_i9j0k1l2'),
    ...
    (25, 'PED-004', 'A', 'Aero Wheelset 50mm', 'RELEASED', 'PED-004_A.sldasm', 'SLDASM', 'Fusion 360', 'v2.0.15044', 'Google Drive', 'https://drive.google.com/cad/pedalforce/PED-004_A.f3d', 12345678, 'T8P5VS01S4053W67', 23, '2022-04-01', '2023-03-10', 'DRW-PED-004-A', 'ASSEMBLY', 'FABRICATED', 'Aero wheelset assembly.', 5, 'tk_pedalforce_q7r8s9t0'),
